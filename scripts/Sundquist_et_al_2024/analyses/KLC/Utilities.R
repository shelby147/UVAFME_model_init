...
# ASP ABI BIR / MIX WSB / APIN / BSP WSPP WSPS / REP OTH / PIN
classes6long = c("Deciduous", "Mixed forest", "Aspen/ pine","Pine","Spruce","Reproductive/ other")
classpal6 = c(brewer.pal(12, "Paired")[c(11,3,7,4,2,5)])
