...
figDir = "UVAFME_scripts/analyses/TVSF/figs/"
...
ggsave("UVAFME_scripts/analyses/TVSF/figs/init_spinup_hist_sankey_4C.png", g, width = 10, height = 8)
...
g <- ggplot(subset(mgmtdat), aes(x = year, next_x = nextyear,
  ...
  ylab("Number of sites") + xlab("Year") + ggtitle("UVAFME initialization vs spinup under historic climate") +
  transparent 
ggsave("UVAFME_scripts/analyses/TVSF/figs/init_spinup_hist_sankey_trans.png", g, width = 10, height = 8)
