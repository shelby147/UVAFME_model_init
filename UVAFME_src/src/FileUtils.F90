...
!*******************************************************************************
    ...
    integer                   :: initspec     ! Unit number for input species initialization file
    integer                   :: initdbh      ! Unit number for input dbh initialization file
    integer                   :: amfile       ! Unit number for input active management file
    ...
    integer                   :: forestry     ! Unit number for forestry output file
    integer                   :: mgmt         ! Unit number for management output file
    integer                   :: siteregen         ! Unit number for site-level renewal output file
    integer                   :: sitefire         ! Unit number for site-level fire output file
