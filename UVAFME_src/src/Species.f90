...
!*******************************************************************************
    ...
    type SpeciesData
        ...
        integer                    :: host           ! Pests (1 oe 0); in development
        integer                    :: plant_dens     ! Post-harvest recommended planting density (per ha)
        ...
        real                       :: fc_recr        ! Effect of seed rain on recruitment (0-1)
        logical                    :: conifer        ! Is species a conifer?
        logical                    :: layering       ! Can species reproduce by layering?
        logical                    :: native         ! Can species reproduce by layering?
...
contains
    ...
    subroutine initialize_species(self, genus_name, taxonomic_name, unique_id, &
        ...
        seedRain_a, seedRain_b, host, plant_dens)
        !
        ...
        real, dimension(5), parameter :: SS = [1.1, 1.15, 1.2, 1.23, 1.3]
        ...
        integer,                   intent(in)     :: host           ! Host (1 or 0), in development
        integer,                   intent(in)     :: plant_dens     ! Post-harvest recommended planting density (per ha)
        ...
        real,                      intent(in)     :: seedRain_a     ! Seed rain parameter
        real,                      intent(in)     :: seedRain_b     ! Seed rain parameter
        ...
        self%seedRain_a     = seedRain_a
        self%seedRain_b     = seedRain_b
        self%host           = host
        self%plant_dens     = plant_dens
    ...
    subroutine copy_species(self, species_data)
        ...
        self%native         = species_data%native
        self%min_recr_dbh   = species_data%min_recr_dbh
        self%seedRain_a     = species_data%seedRain_a
        self%seedRain_b     = species_data%seedRain_b
        self%fc_recr        = species_data%fc_recr
        self%host           = species_data%host
        self%plant_dens     = species_data%plant_dens
    ...
    real function light_rsp(self, al)
        ...
        !     2.24]
        ! Not sure what's going on but the new c1 params produce appropriate light response.
        ! Otherwise, seemed to be a very consequential typo
        real, dimension(5), parameter :: LIGHT_C1 = [1.01, 1.01, 1.07, 1.18,    &
            1.54]
